...
final class Captcha
{
	...
	//公共的构造方法
	public function __construct($codelen=4,$width=100,$height=40,$fontsize=20)
	{
		...
		//字体文件必须是绝对路径
		$this->fontfile = ROOT_PATH."Public".DS."Admin".DS."Image".DS."font.ttf"; 
	...
	private function createFont()
	{
		...
		imagettftext($this->img,$this->fontsize,0,20,30,$color2,$this->fontfile,$this->code);
	}
